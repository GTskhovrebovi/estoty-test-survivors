...
namespace Gameplay
{
    [CreateAssetMenu(fileName = "New Modifier", menuName = "Modifier", order = 1)]
    public class ModifierData : ScriptableObject
    {
        ...
        [field: SerializeField] public List<ModifierEffect> ModifierEffects { get; private set; } = new();
    ...
    {
        Stun, Invisibility, SeeInvisibility
    }
}