...
namespace Gameplay
{
    public class Projectile : WeaponObject
    {
        ...
        private void CheckCollision()
        {
            ...
            var size = Physics2D.CircleCastNonAlloc(_previousPosition, collisionRadius * transform.localScale.x,
                direction, _hits, distance, _hitLayerMask);
            Debug.DrawLine(_previousPosition, (Vector3)_previousPosition + (Vector3)(direction * distance),
                Color.green);
